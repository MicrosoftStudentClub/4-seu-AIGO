...
data_dir = 'CIFAR-10'
full_data_dir = 'CIFAR-10/cifar-10-batches-py/data_batch_'
vali_dir = 'CIFAR-10/cifar-10-batches-py/test_batch'
...
# Number of files you want to read in (from 0 to 5)
NUM_TRAIN_BATCH = 5 
